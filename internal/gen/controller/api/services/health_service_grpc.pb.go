...
func (c *healthServiceClient) GetHealth(ctx context.Context, in *GetHealthRequest, opts ...grpc.CallOption) (*GetHealthResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/controller.api.services.v1.HealthService/GetHealth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HealthService_GetHealth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/controller.api.services.v1.HealthService/GetHealth",
	}
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "controller.api.services.v1.HealthService",
	...
	Metadata: "controller/api/services/v1/health_service.proto",
}
